...
<head>
    ...
    <title>DietFix - Login</title>

    <script>
        //Swap div functions, replaces sign in with sign up
...
<body class="index-body">
    <div class="index_login-page">
        <div class="index_form">
            <img src="img/logo/dietfix.png" class="logo" id="logo-index">
            ...
            <div style="display:none">
                <div id="signup-div">
                    <form class="index_register-form">
                        ...
                        <p class="message index_message" onclick="window.location.reload()">
                            <a class="text-blue" href="index.php">Return to Sign In</a>
                        </p>
